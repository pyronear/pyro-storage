...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("label", sa.Enum("WILDFIRE", "NOTHING", "UNSURE", name="label")),
    ...
    op.create_table(
        ...
        sa.Column("bbox_verified", sqlmodel.sql.sqltypes.AutoString()),
        sa.Column("model_prediction", sqlmodel.sql.sqltypes.AutoString()),
        sa.Column("created_at", sa.DateTime(), nullable=False),
